...
namespace Assets.Scripts.GameLogic
{
    public class SessionManager : MonoBehaviour
    {
        ...
        {
            Debug.Log("Inventory current " + CurrentInvPosition);
        ...
        {
                PickableItem pickableItem = Instantiate(CurrentItem.prefab, GameHandler.Instance.player.transform.position
                    , Quaternion.identity).GetComponent<PickableItem>();
                pickableItem.InitItem(CurrentItem);
